    ...
    const { mutate: createCheckoutSession, isLoading } =
        trpc.payment.createSession.useMutation({
            ...
            onError: (error) => {
                ...
                alert('Ошибка при создании сессии оплаты. Пожалуйста, попробуйте еще раз.');
            }
        });
                        ...
                        {items.length === 0 ? (
                            <div className="flex h-full flex-col items-center justify-center space-y-1">
                                <div aria-hidden="true" className="relative mb-4 h-40 w-40 text-muted-foreground">
                                    <Image src='/empty.png' fill loading='eager' alt='empty shopping cart hippo' />
                                </div>
                                ...
                                <p className='text-muted-foreground text-center'>
                                    Упс! Пока здесь нечего показать.
                                </p>
                            </div>
                        ) : null}
                            ...
                            {isMounted && items.map(({product}) => {
                                ...
                                return (
                                    <li key={product.id} className="flex py-6 sm:py-10">
                                        ...
                                        <div className="ml-4 flex flex-1 flex-col justify-between sm:">
                                            ...
                                            <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                                                ...
                                                <span>Возможность мгновенной доставки</span>
                                            </p>
                                        </div>
                                    </li>
                                )
                        ...
                        <div className="mt-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                                <div className="flex items-center text-sm text-muted-foreground">
                                    <span>Фиксированная комиссия за транзакцию</span>
                                </div>
