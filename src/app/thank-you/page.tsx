                    ...
                    <div className="lg:col-start-2">
                        ...
                        {order._isPaid ? (
                            <p className="mt-2 text-base text-muted-foreground">
                                Ваш заказ был обработан, и ваши активы 
                                доступны для загрузки ниже. Мы отправили
                                вашу квитанцию ​​и данные заказа на{' '}
                            ...
                            <p className="mt-2 text-base text-muted-foreground">
                                 Мы ценим ваш заказ, и мы
                                сейчас обрабатываем его. Так что подождите, и
                                мы отправим вам подтверждение очень скоро!
                            </p>
                        )}
